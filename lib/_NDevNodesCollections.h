...
namespace NDev
{
	namespace Types
	{
		...
		template<typename TypeValue>
		struct TList : public TCollection<TypeValue>, public TIterable<typename std::list<TypeValue>::iterator, typename std::list<TypeValue>::const_iterator>
		{
		...
		struct TArray : public TCollection<TypeValue>, public TIterable<typename std::array<TypeValue, SizeArray>::iterator, typename std::array<TypeValue, SizeArray>::const_iterator>
		{
		...
		struct TSet : public TCollection<TypeValue>, public TIterable<typename std::set<TypeValue, ClassCompare>::iterator, typename std::set<TypeValue, ClassCompare>::const_iterator>
		{
		...
		struct TMap : public TCollection<TypeValue>, public TIterable<typename std::map<TypeKey, TypeValue>::iterator, typename std::map<TypeKey, TypeValue>::const_iterator>
		{
